...
class ResearchSuggestionsModule_20 extends AbstractModule implements 
  ...
  public function onBoot(): void {
    ...
    View::registerCustomView('::components/select-source', $this->name() . '::components/select-source_20');

    // Replace existing views with our own versions.
    View::registerCustomView('::lists/sources-table', $this->name() . '::lists/sources-table_20');

    //TODO Issue #2
    // Replace existing views with our own versions.
    View::registerCustomView('::cards/add-sour-data-even', $this->name() . '::cards/add-sour-data-even_20');

    //TODO Issue #2
    // Replace existing views with our own versions.
    View::registerCustomView('::admin/trees-preferences', $this->name() . '::admin/trees-preferences_20');
    View::registerCustomView('::admin/trees-preferences-ext', $this->name() . '::admin/trees-preferences-ext_20');
